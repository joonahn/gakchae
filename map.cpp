...
Map::Map(MainWindow *_mainwindow)
{
    ...
    junwis[0] = new SJW(this, this, 350,150);
    junwis[1] = new SJW(this, this, 2950,350);
    junwis[2] = new SJW(this, this, 1250,800);
    junwis[3] = new SJW(this, this, 1300,300);
    junwis[4] = new SJW(this, this, 1850,300);
    junwis[5] = new SJW(this, this, 3050,200);
